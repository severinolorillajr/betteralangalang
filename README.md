...
A community-built transparency portal for **Alangalang, Leyte** — local government
services, departments, budgets, projects and contacts, in one place and in plain
language.

> **This is not an official website of the Municipality of Alangalang.** It is an
...
Directory entry: `Alangalang, Leyte` in [jmacj/better-lgu-directory](https://github.com/jmacj/better-lgu-directory).
...
- [ ] Register `betteralangalang.org` and deploy
...
Alangalang. Corrections to published data are the single most useful contribution.
